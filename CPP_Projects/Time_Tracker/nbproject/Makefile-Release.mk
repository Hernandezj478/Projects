...
${OBJECTDIR}/lib/include/SHA1.o: lib/include/SHA1.cpp
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/lib/include/SHA1.o lib/include/SHA1.cpp

${OBJECTDIR}/lib/include/SHA256.o: lib/include/SHA256.cpp
	${MKDIR} -p ${OBJECTDIR}/lib/include
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/lib/include/SHA256.o lib/include/SHA256.cpp

${OBJECTDIR}/lib/include/Scanner.o: lib/include/Scanner.cpp
	${MKDIR} -p ${OBJECTDIR}/lib/include
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/lib/include/Scanner.o lib/include/Scanner.cpp

${OBJECTDIR}/lib/src/AdminUser.o: lib/src/AdminUser.cpp
	${MKDIR} -p ${OBJECTDIR}/lib/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/lib/src/AdminUser.o lib/src/AdminUser.cpp

${OBJECTDIR}/lib/src/Application.o: lib/src/Application.cpp
	${MKDIR} -p ${OBJECTDIR}/lib/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/lib/src/Application.o lib/src/Application.cpp

${OBJECTDIR}/lib/src/Course.o: lib/src/Course.cpp
	${MKDIR} -p ${OBJECTDIR}/lib/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/lib/src/Course.o lib/src/Course.cpp

${OBJECTDIR}/lib/src/Menu.o: lib/src/Menu.cpp
	${MKDIR} -p ${OBJECTDIR}/lib/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/lib/src/Menu.o lib/src/Menu.cpp

${OBJECTDIR}/lib/src/StandardUser.o: lib/src/StandardUser.cpp
	${MKDIR} -p ${OBJECTDIR}/lib/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/lib/src/StandardUser.o lib/src/StandardUser.cpp

${OBJECTDIR}/lib/src/TimeTracker.o: lib/src/TimeTracker.cpp
	${MKDIR} -p ${OBJECTDIR}/lib/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/lib/src/TimeTracker.o lib/src/TimeTracker.cpp

${OBJECTDIR}/lib/src/User.o: lib/src/User.cpp
	${MKDIR} -p ${OBJECTDIR}/lib/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/lib/src/User.o lib/src/User.cpp
